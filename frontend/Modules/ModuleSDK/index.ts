...
export { VirtualAssistant } from '../Industry/SME/VirtualAssistant';
...
export { RecommendationSystem } from '../Industry/Retail/RecommendationSystem';
export { MedicalRecordAssistant } from '../Industry/Healthcare/MedicalRecordAssistant';
export { NursingSchedule } from '../Industry/Healthcare/NursingSchedule';
...
export { RouteOptimizer } from '../Industry/Logistics/RouteOptimizer';
export { InventoryOptimizer } from '../Industry/Logistics/InventoryOptimizer';
export { WarehouseScheduler } from '../Industry/Logistics/WarehouseScheduler';
export { CargoTrackingModule as CargoTracking } from '../Industry/Logistics/CargoTracking';
...
export { SecurityMonitor } from '../Industry/Government/SecurityMonitor';

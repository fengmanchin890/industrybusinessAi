-- ========================================
-- AI 虚拟助理 - 快速设置 SQL (修复版)
-- ========================================
-- 解决 user_companies 表不存在的问题
-- ========================================

-- 步骤 1: 先检查并创建 user_companies 表（如果不存在）
...
-- user_companies RLS 策略
CREATE POLICY IF NOT EXISTS "Users can view their own company relationships"
...
-- ========================================
-- 步骤 8: 为当前用户添加 user_companies 关系
-- ========================================

-- 将当前登录的用户添加到 user_companies（如果还没有的话）
